package com.adalbertosn1982.applicationmanagementsystem;
...
public class ApplicationManagementSystemApplication {
    ...
    public static void main(String[] args) {
        ApplicationContext context = SpringApplication.run(ApplicationManagementSystemApplication.class, args);
    }
